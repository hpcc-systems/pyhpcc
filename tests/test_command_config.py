...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            "ecl run /usr/loc/Basic_job_submission.eclxml --target thor --job-name my_custom_workunit --limit 100 -s university.us-hpccsystems-dev.azure.lnrsg.io --port 8010 -u rpodugu -pw 340K5pogTWqxekqt",
        ),
        (
            "/usr/loc/Basic_job_submission.eclxml",
            {
            ...
            "ecl run /usr/loc/Basic_job_submission.eclxml --target thor --job-name Basic_job_submission --limit 100 -s university.us-hpccsystems-dev.azure.lnrsg.io --port 8010 -u rpodugu -pw 340K5pogTWqxekqt",
        ),
        (
            "/usr/loc/Basic_job_submission.eclxml",
            {
            ...
            "ecl run /usr/loc/Basic_job_submission.eclxml --target thor -v --job-name Basic_job_submission --limit 100 -s university.us-hpccsystems-dev.azure.lnrsg.io --port 8010 -u rpodugu -pw 340K5pogTWqxekqt",
        ),
    ],
)
